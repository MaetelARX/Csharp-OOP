...
namespace PizzaCalories
{
    public class Dough
    {
        ...
        public double Calories
        {
            get
            {
                double flourType = flourTypesCalories[FlourType];
                double technique = bakingTechniquesCalories[BakingTechnique];
                
                return BaseCaloriesPerGram * weight * flourType * technique;
            }
